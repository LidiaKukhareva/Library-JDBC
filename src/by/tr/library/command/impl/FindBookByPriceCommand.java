...
public class FindBookByPriceCommand implements Command{
	...
	public Response execute(Request request) throws CommandException{
		...
		try {
			...
			if (valid){
				Book book = service.findBookByPrice(request.getPrice());
				if (book != null){
			...
			log.error("ServiceException: method execute, class FindBookByPriceCommand");
